                ...
                <div class="col-lg-12">
					...
					?>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
										<tr>
											...
											<td>
											<a href="inbox.php?a=hapus&id=<?php echo $row['ID'] ?>" class="btn btn-danger btn-xs">DELETE</a>
											</td>
										</tr>
									</tbody>
									<?php
						...
						?>
							...
							<div class="panel-body">
								<div class="table-responsive">
									<a href="inbox.php?a=reset">Batal</a>
									<br>
									<form action="inbox.php?a=reset" method="post">
...
<?php
		...
		function sql_select()
			{
			global $kdb;
			$sql = " select ID,SenderNumber, TextDecoded, ReceivingDateTime,Processed from inbox Order By ReceivingDateTime DESC;"; 
		...
		function sql_delete()
		{
		  global $kdb;
		  global $_POST; 
		  $sql  = " delete from inbox where ID = ".$_POST["IDX"];			  
