                ...
                <div class="col-lg-12">
					...
					?>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
										<tr>
											...
											<td>
											<a href="sent-items.php?a=hapus&id=<?php echo $row['ID'] ?>" class="btn btn-danger btn-xs">DELETE</a></td>
						...
						?>
							...
							<div class="panel-body">
								<div class="table-responsive">
									<a href="sent-items.php?a=reset>Batal</a>
									<br>
									<form action="sent-items.php?a=reset" method="post">
									<input type="hidden" name="sql" value="delete" >
									<input type="hidden" name="IDX" value="<?php echo $ID;?>" >
									<h3> Anda yakin akan menghapus pesan ini?</h3>
					
									<p><input type="submit" name="action" value="Delete" class="btn btn-danger btn-xs ></p>
									</form>
								</div>
								<!-- /.table-responsive -->
							</div>
...
<?php
		...
		function sql_select()
			{
			global $kdb;
			$sql = " select ID, DestinationNumber, TextDecoded, SendingDateTime from sentitems Order By SendingDateTime DESC;";  
		...
		{
			global $kdb;
			$sql = " select * from sentitems where ID =".$ID;
		...
		function sql_delete()
		{
		  global $kdb;
		  global $_POST; 
		  $sql  = " delete from sentitems where ID = ".$_POST["IDX"];			  
